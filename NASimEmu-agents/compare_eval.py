...
train_eval_command = (
    ...
    "-load_model wandb/latest-run/files/model.pt -device cpu -cpus 8 "
...
OUTPUT_FILENAME = "vaA_VarB_C.json"
# Optional run description (can be overridden by --desc)
DESCRIPTION = "Model trained with 0.8 base train, 0.2 varA 0.2 varB scenarios completed "
# =============================================================================
